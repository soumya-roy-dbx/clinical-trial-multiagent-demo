...
# production the same files live in a UC Volume — point DOCS_DIR at that
# path (with appropriate Databricks SDK file IO) when running from a job.
DOCS_DIR = ROOT / "data" / "docs"
TABLE = os.getenv(
    "PROTOCOL_CHUNKS_TABLE", "your_catalog.your_schema.protocol_chunks"
)
